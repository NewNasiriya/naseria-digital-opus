  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `https://naseria-digital-opus.lovable.app/gallery/${album.slug}` },
      ...
      links: [{ rel: "canonical", href: `https://naseria-digital-opus.lovable.app/gallery/${album.slug}` }],
    };
  },
  errorComponent: () => (
    <>
