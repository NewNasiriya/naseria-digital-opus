  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `https://naseria-digital-opus.lovable.app/academic/grades/${params.level}` },
      ],
      links: [{ rel: "canonical", href: `https://naseria-digital-opus.lovable.app/academic/grades/${params.level}` }],
    };
  },
  notFoundComponent: () => (
